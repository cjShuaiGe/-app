...
import com.example.projectmonitoringapp.adapter.UserMonitorPowerAdapter;
...
public class MonitorPowerFragment extends Fragment {

    private RecyclerView recyclerView;
    List<Project> list = new ArrayList<>();
    private UserMonitorPowerAdapter adapter;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_monitor_power,container,false);
        recyclerView = view.findViewById(R.id.user_monitor_power);
        //TODO

        adapter = new UserMonitorPowerAdapter(list,getActivity());
