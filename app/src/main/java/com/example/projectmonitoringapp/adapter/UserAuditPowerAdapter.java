...
public class UserAuditPowerAdapter extends RecyclerView.Adapter<UserAuditPowerAdapter.ViewHolder> {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            name=view.findViewById(R.id.tv_audit_name);
            introduction=view.findViewById(R.id.tv_introduction);
            bt_monitor=view.findViewById(R.id.bt_monitor);
            bt_audit=view.findViewById(R.id.bt_audit);
            status=view.findViewById(R.id.project_audit_status);
        }

    }

    public UserAuditPowerAdapter(List<Project> list, Activity activity) {
        mlist = list;
        mactivity = activity;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_user_audit_power,parent,false);
        UserAuditPowerAdapter.ViewHolder holder = new UserAuditPowerAdapter.ViewHolder(view);
        return holder;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.bt_audit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(mactivity, UserProjectMonitorActivity.class);
                intent.putExtra("name",holder.name.getText().toString());
